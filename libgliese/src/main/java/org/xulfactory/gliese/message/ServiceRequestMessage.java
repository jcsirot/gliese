 ...
 * @author sirot
 */
public class ServiceRequestMessage extends SSHMessage
{
	...
	{
		serviceName = Utils.decodeString(in);
	}

	@Override
	protected void encode(OutputStream out) throws IOException
	{
		Utils.encodeString(out, serviceName);
	}
	...
	public String toString()
	{
		...
		sb.append("SSH_MSG_SERVICE_REQUEST, ");
